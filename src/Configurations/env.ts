...
export const RAZORPAY_TEST_API_KEY = import.meta.env.VITE_RAZORPAY_TEST_API_KEY;
export const RAZORPAY_TEST_SECRET_KEY = import.meta.env.VITE_RAZORPAY_TEST_SECRET_KEY;
