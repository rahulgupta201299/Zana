...
export const createPaymentOrdeActions = traceActionsCreator(
  createPaymentOrderName,
);
...
export const verifyPaymentOrdeActions = traceActionsCreator(
  verifyPaymentOrderName,
);
